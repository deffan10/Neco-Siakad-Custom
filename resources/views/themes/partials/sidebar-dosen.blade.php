...
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('dosen.jurnal*') ? 'active' : '' }}" href="{{ route('dosen.jurnal.index') }}">
        <span class="nav-link-icon d-md-none d-lg-inline-block">
        ...
        <span class="nav-link-title">Jurnal Mengajar</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('dosen.perwalian*') ? 'active' : '' }}" href="{{ route('dosen.perwalian.index') }}">
        <span class="nav-link-icon d-md-none d-lg-inline-block">
        ...
        <span class="nav-link-title">PA Online (Chat)</span>
    </a>
</li>
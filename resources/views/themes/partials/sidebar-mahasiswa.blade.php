...
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('mahasiswa.wisuda*') ? 'active' : '' }}" href="{{ route('mahasiswa.wisuda.index') }}">
        <span class="nav-link-icon d-md-none d-lg-inline-block">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M22 9l-10 -4l-10 4l10 4l10 -4v6" /><path d="M6 10.6v5.4a6 3 0 0 0 12 0v-5.4" /></svg>
        </span>
        <span class="nav-link-title">Pendaftaran Wisuda</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('mahasiswa.skl*') ? 'active' : '' }}" href="{{ route('mahasiswa.skl.index') }}">
        <span class="nav-link-icon d-md-none d-lg-inline-block">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M5 12v-7a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" /><path d="M12 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M12 9v3h3" /></svg>
        </span>
        <span class="nav-link-title">Cetak SKL</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('*.kuesioner*') ? 'active' : '' }}" href="{{ route(session('active_role', 'mahasiswa') . '.kuesioner.index') }}">
        <span class="nav-link-icon d-md-none d-lg-inline-block">
...
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('mahasiswa.seminar*') ? 'active' : '' }}" href="{{ route('mahasiswa.seminar.index') }}">
        <span class="nav-link-icon d-md-none d-lg-inline-block">
...
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('mahasiswa.sertifikasi*') ? 'active' : '' }}" href="{{ route('mahasiswa.sertifikasi.index') }}">
        <span class="nav-link-icon d-md-none d-lg-inline-block">

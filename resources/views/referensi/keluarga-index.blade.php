        ...
        <div class="col-lg-8 col-12 mb-2">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        @if($is_trash)
                            <a href="{{ route($activeRole . '.referensi.keluarga-index') }}" class="btn btn-sm btn-secondary me-2">
                                <i class="fas fa-arrow-left me-2"></i>Kembali
                            </a>
                        @else
                            <a href="{{ route($activeRole . '.referensi.keluarga-trash') }}" class="btn btn-sm btn-warning me-2">
                    ...
                    @if(!$is_trash)
                        <div class="collapse" id="collapseForm">
                            <div class="card card-body border">
                                ...
                                <form action="{{ route($activeRole . '.referensi.keluarga-store') }}" method="post">
                                    @csrf
                                    <div class="row">
                        ...
                        <table class="table table-striped table-bordered" id="keluargaTable">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Aksi">
                                            @if($is_trash)
                                                <form action="{{ route($activeRole . '.referensi.keluarga-restore', $item->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                            ...
                                            @else
                                                ...
                                                <form action="{{ route($activeRole . '.referensi.keluarga-destroy', $item->id) }}" method="POST" class="d-inline" id="delete-form-{{ $item->id }}">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            <div class="list-group">
                                @foreach($keluargas->sortByDesc('created_at')->take(3) as $item)
                                    <div class="list-group-item">
                                        ...
                                        <p class="mb-1">{{ $item->hubungan }} dari {{ $item->owner_name }}</p>
            ...
            <div class="modal fade" id="editData{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel{{ $item->id }}" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <form action="{{ route($activeRole . '.referensi.keluarga-update', $item->id) }}" method="POST">
                            @method('PATCH')
                            @csrf

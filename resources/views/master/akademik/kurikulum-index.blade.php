                                ...
                                @foreach($kurikulums as $index => $item)
                                    <tr>
                                        ...
                                        <td data-label="Aksi">
                                            ...
                                            @else
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#editData{{ $item->id }}" class="btn btn-sm btn-primary me-1" data-bs-toggle="tooltip" title="Edit Kurikulum">
            ...
            <div class="modal fade" id="editData{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel{{ $item->id }}" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <form action="{{ route('akademik.kurikulum-update', $item->id) }}" method="POST">
                            @method('PATCH')
                            @csrf
                            <div class="modal-header">
                                <h5 class="modal-title" id="editModalLabel{{ $item->id }}">Edit Kurikulum - {{ $item->name }}</h5>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" name="program_studi_id" id="edit_program_studi_id{{ $item->id }}" required>
                                            ...
                                            @foreach($programStudi as $ps)
                                                <option value="{{ $ps->id }}" {{ $item->program_studi_id == $ps->id ? 'selected' : '' }}>{{ $ps->name }} ({{ $ps->code }})</option>
                                            @endforeach
                                        </select>
                                        @error('program_studi_id')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_name{{ $item->id }}" class="form-label">Nama Kurikulum <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="name" id="edit_name{{ $item->id }}" value="{{ $item->name }}" placeholder="Masukkan nama kurikulum" required>
                                        @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_code{{ $item->id }}" class="form-label">Kode Kurikulum <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="code" id="edit_code{{ $item->id }}" value="{{ $item->code }}" placeholder="Masukkan kode kurikulum" required>
                                        @error('code')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_tahun_berlaku{{ $item->id }}" class="form-label">Tahun Berlaku <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="tahun_berlaku" id="edit_tahun_berlaku{{ $item->id }}" value="{{ $item->tahun_berlaku }}" placeholder="Masukkan tahun berlaku" min="1900" max="{{ date('Y') + 10 }}" required>
                                        @error('tahun_berlaku')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_tahun_berakhir{{ $item->id }}" class="form-label">Tahun Berakhir</label>
                                        <input type="number" class="form-control" name="tahun_berakhir" id="edit_tahun_berakhir{{ $item->id }}" value="{{ $item->tahun_berakhir }}" placeholder="Masukkan tahun berakhir" min="1900" max="{{ date('Y') + 10 }}">
                                        @error('tahun_berakhir')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_awal_tahun_akademik_id{{ $item->id }}" class="form-label">Tahun Akademik Awal <span class="text-danger">*</span></label>
                                        <select class="form-select" name="awal_tahun_akademik_id" id="edit_awal_tahun_akademik_id{{ $item->id }}" required>
                                            <option value="">Pilih Tahun Akademik Awal</option>
                                            @foreach($tahunAkademik as $ta)
                                                <option value="{{ $ta->id }}" {{ $item->awal_tahun_akademik_id == $ta->id ? 'selected' : '' }}>{{ $ta->name }} ({{ $ta->code }})</option>
                                            @endforeach
                                        </select>
                                        @error('awal_tahun_akademik_id')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_akhir_tahun_akademik_id{{ $item->id }}" class="form-label">Tahun Akademik Akhir <span class="text-danger">*</span></label>
                                        <select class="form-select" name="akhir_tahun_akademik_id" id="edit_akhir_tahun_akademik_id{{ $item->id }}" required>
                                            <option value="">Pilih Tahun Akademik Akhir</option>
                                            @foreach($tahunAkademik as $ta)
                                                <option value="{{ $ta->id }}" {{ $item->akhir_tahun_akademik_id == $ta->id ? 'selected' : '' }}>{{ $ta->name }} ({{ $ta->code }})</option>
                                            @endforeach
                                        </select>
                                        @error('akhir_tahun_akademik_id')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_total_sks_lulus{{ $item->id }}" class="form-label">Total SKS Lulus <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="total_sks_lulus" id="edit_total_sks_lulus{{ $item->id }}" value="{{ $item->total_sks_lulus }}" placeholder="Masukkan total SKS lulus" min="1" max="300" required>
                                        @error('total_sks_lulus')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_sks_wajib{{ $item->id }}" class="form-label">SKS Wajib <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="sks_wajib" id="edit_sks_wajib{{ $item->id }}" value="{{ $item->sks_wajib }}" placeholder="Masukkan SKS wajib" min="0" required>
                                        @error('sks_wajib')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_sks_pilihan{{ $item->id }}" class="form-label">SKS Pilihan <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="sks_pilihan" id="edit_sks_pilihan{{ $item->id }}" value="{{ $item->sks_pilihan }}" placeholder="Masukkan SKS pilihan" min="0" required>
                                        @error('sks_pilihan')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_semester_normal{{ $item->id }}" class="form-label">Semester Normal <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="semester_normal" id="edit_semester_normal{{ $item->id }}" value="{{ $item->semester_normal }}" placeholder="Masukkan semester normal" min="1" max="14" required>
                                        @error('semester_normal')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_ipk_minimal{{ $item->id }}" class="form-label">IPK Minimal <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="ipk_minimal" id="edit_ipk_minimal{{ $item->id }}" value="{{ $item->ipk_minimal }}" placeholder="Masukkan IPK minimal" step="0.01" min="0" max="4" required>
                                        @error('ipk_minimal')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control" name="deskripsi" id="edit_deskripsi{{ $item->id }}" placeholder="Masukkan deskripsi kurikulum" rows="3">{{ $item->deskripsi }}</textarea>
                                        @error('deskripsi')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_sk_penetapan{{ $item->id }}" class="form-label">SK Penetapan</label>
                                        <input type="text" class="form-control" name="sk_penetapan" id="edit_sk_penetapan{{ $item->id }}" value="{{ $item->sk_penetapan }}" placeholder="Masukkan SK penetapan">
                                        @error('sk_penetapan')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_tanggal_sk{{ $item->id }}" class="form-label">Tanggal SK</label>
                                        <input type="date" class="form-control" name="tanggal_sk" id="edit_tanggal_sk{{ $item->id }}" value="{{ $item->tanggal_sk }}">
                                        @error('tanggal_sk')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
